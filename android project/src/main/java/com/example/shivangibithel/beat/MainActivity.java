...
public class MainActivity extends TabActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spec = tabHost.newTabSpec("Queue"); // Create a new TabSpec using tab host
        ...
        spec = tabHost.newTabSpec("Mood"); // Create a new TabSpec using tab host
        spec.setIndicator("MOOD");
        // Create an Intent to launch an Activity for the tab (to be reused)
        intent = new Intent(MainActivity.this, mood.class);
        spec.setContent(intent);
        tabHost.addTab(spec);
